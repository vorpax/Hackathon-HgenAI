...
class CavitesApi(object):
    ...
    def recherche_risques8(self, **kwargs):  # noqa: E501
        ...
        :param str identifiant: Identifiant de la cavité souterraine
        :param str type: Type de cavité souterraine                                     <br>- Cave <br>- Naturelle <br>- Indéterminé <br>- Ouvrage civil <br>- Puits <br>- Divers <br>- Galerie <br>- Carrière <br>- Indice <br>- Ouvrage militaire <br>- Réseau galeries <br>- Souterrain
        :return: PaginatedResponseCavites
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.recherche_risques8_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.recherche_risques8_with_http_info(**kwargs)  # noqa: E501
            return data

    def recherche_risques8_with_http_info(self, **kwargs):  # noqa: E501
        """Cette interface est conçue pour diffuser les données sur les cavités souterraines.  # noqa: E501

        Cette interface est conçue pour diffuser les données sur les cavités souterraines.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.recherche_risques8_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['rayon', 'latlon', 'code_insee', 'page', 'page_size', 'region', 'departement', 'identifiant', 'type']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method recherche_risques8" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='PaginatedResponseCavites',  # noqa: E501
