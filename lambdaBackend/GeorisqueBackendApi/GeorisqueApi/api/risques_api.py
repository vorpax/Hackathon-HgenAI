...
class RisquesApi(object):
    ...
    def recherche_risques4(self, **kwargs):  # noqa: E501
        """Lister les types de risques recensés sur le territoire concerné  # noqa: E501

        Ce service permet de lister les types de risques recensés sur le territoire concerné, suivant une emprise spatiale définie, à  savoir un rayon de recherche pour un point défini, une ou plusieurs communes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.recherche_risques4(async_req=True)
        >>> result = thread.get()
        ...
        :return: PaginatedResponseRisques
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.recherche_risques4_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.recherche_risques4_with_http_info(**kwargs)  # noqa: E501
            return data

    def recherche_risques4_with_http_info(self, **kwargs):  # noqa: E501
        """Lister les types de risques recensés sur le territoire concerné  # noqa: E501

        Ce service permet de lister les types de risques recensés sur le territoire concerné, suivant une emprise spatiale définie, à  savoir un rayon de recherche pour un point défini, une ou plusieurs communes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.recherche_risques4_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method recherche_risques4" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='PaginatedResponseRisques',  # noqa: E501
