...
class ZonageSismiqueApi(object):
    ...
    def recherche_radon(self, **kwargs):  # noqa: E501
        """Lister les zonages sismiques  # noqa: E501

        Ce service permet de lister le zonage sismique, suivant une emprise spatiale définie, à  savoir un rayon de recherche pour un point défini, une ou plusieurs communes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.recherche_radon(async_req=True)
        >>> result = thread.get()
        ...
        :return: PaginatedResponseZonageSismique
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.recherche_radon_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.recherche_radon_with_http_info(**kwargs)  # noqa: E501
            return data

    def recherche_radon_with_http_info(self, **kwargs):  # noqa: E501
        """Lister les zonages sismiques  # noqa: E501

        Ce service permet de lister le zonage sismique, suivant une emprise spatiale définie, à  savoir un rayon de recherche pour un point défini, une ou plusieurs communes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.recherche_radon_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='PaginatedResponseZonageSismique',  # noqa: E501
