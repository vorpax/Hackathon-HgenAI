...
class AZIApi(object):
    ...
    def recherche_risques7(self, **kwargs):  # noqa: E501
        """Lister les Atlas de Zones Inondables (AZI) recensés sur le territoire concerné  # noqa: E501

        Ce service permet de lister les Atlas de Zones Inondables (AZI) recensés sur le territoire concerné, suivant une emprise spatiale définie, à  savoir un rayon de recherche pour un point défini, une ou plusieurs communes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.recherche_risques7(async_req=True)
        >>> result = thread.get()
        ...
        :return: PaginatedResponseAzi
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.recherche_risques7_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.recherche_risques7_with_http_info(**kwargs)  # noqa: E501
            return data

    def recherche_risques7_with_http_info(self, **kwargs):  # noqa: E501
        """Lister les Atlas de Zones Inondables (AZI) recensés sur le territoire concerné  # noqa: E501

        Ce service permet de lister les Atlas de Zones Inondables (AZI) recensés sur le territoire concerné, suivant une emprise spatiale définie, à  savoir un rayon de recherche pour un point défini, une ou plusieurs communes.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.recherche_risques7_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method recherche_risques7" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='PaginatedResponseAzi',  # noqa: E501
